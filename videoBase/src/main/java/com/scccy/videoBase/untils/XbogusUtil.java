...
public class XbogusUtil {
    ...
    private static final byte[] UA_KEY = new byte[]{0x00, 0x01, 0x0c};
    private String userAgent;


    public XbogusUtil(String userAgent) {
...
//        String params = urlPath + "&X-Bogus=" + xb.toString();
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        XbogusUtil xbogus = new XbogusUtil(ua);
        ...
        String dyXbogus = XbogusUtil.getXBogus(dyUrlParams);
        System.out.println(dyXbogus);

        String tkXbogus = XbogusUtil.getXBogus(tkUrlParams);
        System.out.println(tkXbogus);
    }
}
