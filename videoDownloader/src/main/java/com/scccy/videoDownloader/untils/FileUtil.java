...
public class FileUtil {
    ...
    public static String createDirFile(String directory, String ext, String filename, String platform) {
        ...
        return Paths.get(directory, platform, datepath, filename, filename + ext).toString();
    }
    ...
    public static String createTemporaryDirectory(String platform, String filename, String directory) {
        String datePath = getDatePath();
        return Paths.get(directory, platform, datePath, filename).toString();
    }
    ...
    public static String createTemporaryDirectory(String platform, String filename) {
        String datepath = getDatePath();
        return Paths.get(Global.UPLOAD_PATH, platform, datepath, filename).toString();
    }
    ...
    private static String getDatePath() {
        return DateUtils.getDate("yyyy") + "/" + DateUtils.getDate("MM");
    }
     ...
     */
    public static void copyDir(String oldDir, String newDir) throws IOException {
        Path srcDir = Paths.get(oldDir);
        Path destDir = Paths.get(newDir);
        ...
        Files.walkFileTree(srcDir, new SimpleFileVisitor<Path>() {
            ...
            public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
                Path targetPath = destDir.resolve(srcDir.relativize(file));
     ...
     * 复制文件
     * @param oldFile 原来的文件
     * @param newFile 复制到的文件
     */
    public static void copyFile(Path oldFile, Path newFile) throws IOException {
    ...
    public static boolean deleteParentDirectorie(String path) {
        ...
        return deleteDirectory(parentDirectory.getPath());
    }
    ...
    * 写入文件
    ...
    public static void main(String[] args) {
        FileUtil.deleteParentDirectorie("D:\\home\\spirit\\video\\111\\111.txt");
    }
}