...
class UserProfileFilter(JSONModel):
    ...
    @property
    def diggCount(self):
        return self._get_attr_value("$.anchorInfo.stats.diggCount")

    @property
    def followerCount(self):
        return self._get_attr_value("$.anchorInfo.stats.followerCount")

    @property
    def followingCount(self):
        return self._get_attr_value("$.anchorInfo.stats.followingCount")

    @property
    def friendCount(self):
        return self._get_attr_value("$.anchorInfo.stats.friendCount")

    @property
    def heartCount(self):
        return self._get_attr_value("$.anchorInfo.stats.heartCount")

    @property
    def videoCount(self):
        return self._get_attr_value("$.anchorInfo.stats.videoCount")

    # user
    @property
    def uid(self):
        return self._get_attr_value("$.anchorInfo.user.id")

    @property
    def nickname(self):
        return replaceT(self._get_attr_value("$.anchorInfo.user.nickname"))

    @property
    def nickname_raw(self):
        return self._get_attr_value("$.anchorInfo.user.nickname")

    @property
    def secUid(self):
        return self._get_attr_value("$.anchorInfo.user.secUid")

    @property
    def uniqueId(self):
        return self._get_attr_value("$.anchorInfo.user.uniqueId")

    @property
    def commentSetting(self):
        return self._get_attr_value("$.anchorInfo.user.commentSetting")

    @property
    def followingVisibility(self):
        return self._get_attr_value("$.anchorInfo.user.followingVisibility")

    @property
    def openFavorite(self):
        return self._get_attr_value("$.anchorInfo.user.openFavorite")

    @property
    def privateAccount(self):
        return self._get_attr_value("$.anchorInfo.user.privateAccount")

    @property
    def showPlayListTab(self):
        return self._get_attr_value("$.anchorInfo.user.profileTab.showPlayListTab")

    @property
    def relation(self):  # follow 1, no follow 0
        return self._get_attr_value("$.anchorInfo.user.relation")

    @property
    def signature(self):
        return replaceT(self._get_attr_value("$.anchorInfo.user.signature"))

    @property
    def signature_raw(self):
        return self._get_attr_value("$.anchorInfo.user.signature")

    @property
    def ttSeller(self):
        return self._get_attr_value("$.anchorInfo.user.ttSeller")

    @property
    def verified(self):
        return self._get_attr_value("$.anchorInfo.user.verified")
